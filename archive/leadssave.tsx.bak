...
const [hovered, setHovered] = useState<string | null>(null);
  ...
  <a href="/leads" rel="noreferrer" style={styles.navLink}>
    Demo
  </a>
  <a href="https://api.searlio.com/docs" target="_blank" rel="noreferrer" style={styles.navLink}>
    API
  </a>
</div>
      </div>
...
>
          ...
          <p style={styles.subheading}>
            Searlio helps service businesses respond faster to paid leads by surfacing what matters and cutting through the noise.
          </p>
  ...
  <a
    ...
    style={{
      ...styles.primaryBtn,
      transform: hovered === "primary" ? "translateY(-2px)" : "translateY(0)",
      boxShadow:
        hovered === "primary"
  ...
  <a
    ...
    style={{
      ...styles.secondaryBtn,
      transform:
        hovered === "secondary" ? "translateY(-2px)" : "translateY(0)",
      borderColor:
        hovered === "secondary" ? "#06b6d4" : "#334155",
    }}
...
<section style={styles.section}>
  <p style={{ ...styles.p, textAlign: "center", fontWeight: 600 }}>
    Faster response • Less noise • More jobs from the leads you already paid for
  </p>
</section>
        {/* CONTENT */}
        <section style={styles.section}>
...
<section style={styles.section}>
  <h2 style={styles.h2}>This isn’t about notifications. It’s about revenue.</h2>
  <p style={styles.p}>
    You already paid for the lead.
  </p>
  <p style={styles.p}>
    Searlio helps you win it.
  </p>
</section>
...
<section style={styles.cta}>
  ...
  <div style={styles.buttonRow}>
    <a
      ...
      style={{
        ...styles.primaryBtn,
        transform: hovered === "demo2" ? "translateY(-2px)" : "translateY(0)",
        boxShadow:
          hovered === "demo2"
            ? "0 8px 20px rgba(6,182,212,0.4)"
            : "none",
    ...
    <a
      ...
      style={{
        ...styles.secondaryBtn,
        transform: hovered === "setup" ? "translateY(-2px)" : "translateY(0)",
        borderColor:
          hovered === "setup" ? "#06b6d4" : "#334155",
        boxShadow:
          hovered === "setup"
...
const styles: any = {
  ...
  // web fallback (Expo web sometimes needs this)
     elevation: 8,
  },
  navLink: {
    color: "#9ca3af",
 ...
 hero: {
  ...
  background: "radial-gradient(circle at top, rgba(6,182,212,0.08), transparent 70%)",
  padding: "80px 20px",
  borderRadius: "16px",
  },
